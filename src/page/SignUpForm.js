...
const SignUpForm = () => {
    ...
    const handleEmail = (event) => {
        ...
        if (emailRule.test(newEmailValue)) {
            ...
            handleMessageChange('email', '이메일을 다시한번 확인해 주세요.', 'error-color');
            setEmail('');
        }
    }
    ...
    const handleBirth = (event) => {
        ...
        if (birthRule.test(newBirthValue)) {
            handleMessageChange('birth', '올바른 생년월일 입니다.', 'success-color');
        } else if (newBirthValue === "") {
            handleMessageChange('birth', '생년월일을 입력해 주세요', 'error-color');
        } else {
            handleMessageChange('birth', '생년월일을 다시한번 확인해 주세요.', 'error-color');
            setBirth('');
        }
    }
                    ...
                    <ul>
                        ...
                        <li className="birth-section">
                            <div className="area-style">
                                ...
                                <p className="help-style"><IoMdCheckmark />. 를 제외한 8글자 ex)19900101 </p>
                            </div>
                        </li>
                        <li>
                            <br />
                        ...
                        <li id="terms-section">
                            ...
                            <label htmlFor="allCheck">이용약관 및 개인정보수집 및 이용, 쇼핑정보수신(선택)에 모두 동의합니다.</label>
                            <br />
                            <h3>[필수] 이용약관 동의</h3>
                            ...
                            <div className="termsBox">
                                ...
                                <p>
                                    ...
                                    ο 회원 관리
                                    회원제 서비스 이용에 따른 본인확인 , 개인 식별 , 연령확인 , 만14세 미만 아동 개인정보 수집 시 법정 대리인 동의여부 확인 , 고지사항 전달<br /> ο 마케팅 및 광고에 활용<br />
                                    접속 빈도 파악 또는 회원의 서비스 이용에 대한 통계
                                </p>
                                <p>
                                    ■ 개인정보의 보유 및 이용기간
                            ...
                            <p>
                                ...
                                <input type="checkbox" id="terms-check3" className='check-style' checked={snsChecked} onChange={()=>setSnsChecked(!privacyChecked)}/>
